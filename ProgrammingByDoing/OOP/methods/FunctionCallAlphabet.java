...
public class FunctionCallAlphabet {
	public static void main(String[] args) {
		...
		c(true); // pass it 'true' and it will display a word
		// beginning with C
		...
		i(1); // pass it any integer and it will display a word
		// beginning with I
		j(2); // returns a different word depending on what you
		// pass it (1-3)
		k(); // displays a word beginning with K
		l(true, false); // displays a different word depending on the two
		// booleans you pass it
		m(true, false); // displays a different word depending on the two
		// booleans you pass it
		...
		r(false); // returns a different word depending on if you pass
		// it 'true' or 'false'
		...
		w(1); // pass it any integer and it will display a word
		// beginning with W
		x(2); // returns a different word depending on what you
		// pass it (1-2)
		y(); // displays a word beginning with Y
		z(true, false); // returns a different word depending on which two
