...
public class DoWhileSwimming {
	...
	public static void main(String[] args) throws Exception {
		...
		savedTemperature = currentTemperature; // saves a copy of this value so
		...
		while (currentTemperature >= minimumTemperature) {
			...
			currentTemperature -= 0.5; // subtracts 1/2 a degree from the water
										// temperature
		...
		currentTemperature = savedTemperature; // restores original water
												// temperature
